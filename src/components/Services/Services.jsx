...
const services = [
  {
    ...
    image: '/images/services/softpic.jpg',
    icon: (
  ...
  },
  {
    ...
    image: '/images/services/hardwarepic.jpg',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    image: '/images/services/designpic.jpg',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    image: '/images/services/research_development.jpg',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          {services.map((service, i) => (
            ...
            >
              ...
              <div className="service-image">
                <img 
                  src={service.image} 
                  alt={`Illustration of ${service.title} services at Techbrain Networks`} 
                  width="600"
                  height="400"
                  loading="lazy" 
                />
              ...
              <div className="service-content">
                ...
                <button 
                  ...
                  style={{ marginTop: '20px', padding: '10px 24px', fontSize: '0.85rem' }}
